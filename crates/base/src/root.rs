...
use gpui::{
    AnyElement, AnyView, App, AppContext, ClipboardItem, Context, Div, Entity, EventEmitter,
    Global, InteractiveElement, IntoElement, KeyBinding, ParentElement, Render, Stateful,
...
///
/// Presentation plugins that own dialogs emit this on the root so applications
/// can observe modality changes without reaching into a specific plugin.
