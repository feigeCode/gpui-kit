...
use crate::{
    ...
    dialog::{DialogContent, DialogDispatchAnchor, DialogFooter, DialogTitle},
...
impl Dialog {
    ...
    pub fn alert(mut self) -> Self {
        self.button_props = self.button_props.show_cancel(false);
    ...
    pub fn confirm(mut self) -> Self {
        self.button_props = self.button_props.show_cancel(true);
        self.default_footer = true;
        self
    }
